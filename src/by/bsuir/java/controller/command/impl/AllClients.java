...
import by.bsuir.java.view.tableview.impl.ClientsTableView;
...
public class AllClients implements Command {
    ...
    public String execute(String request) throws CommandException {
        ...
        ClientService saleService = serviceFactory.getClientService();
        try {
            List<Client> accounts =  saleService.getAll();
            response = new ClientsTableView().outputTable(accounts);
